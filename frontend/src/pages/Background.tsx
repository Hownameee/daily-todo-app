		...
		<>
			<div className="relative h-screen w-screen overflow-hidden bg-[#0a0a0f] flex flex-col font-sans text-white">
				<div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
					<div className="absolute w-150 h-150 bg-blue-500/20 rounded-full blur-[100px] mix-blend-screen transition-transform duration-75 ease-out will-change-transform z-0" style={{ left: -300, top: -300, transform: `translate(${mousePosition.x}px, ${mousePosition.y}px)` }}></div>
